    ...
    <form action="#" method="GET" class="lg:block">
        <div class="mt-2 relative flex lg:w-[32rem] gap-2">
            ...
            <select id="shift"
                ...
                <option value="SAD">System Design</option>
            </select>
            <select id="year"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2">
            ...
            <button
                class="px-4 py-2 bg-gray-50 outline-none border border-indigo-100 rounded-lg text-gray-900 font-medium active:scale-95 hover:bg-green-600 hover:text-white focus:ring-2 focus:ring-green-600 focus:ring-offset-2 disabled:bg-gray-400/80 disabled:shadow-none disabled:cursor-not-allowed transition-colors duration-200">Add</button>
            ...
            <tbody class="text-gray-600 text-sm font-light">
                @for ($i = 1; $i < 6; $i++)
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex items-center">
                                <span class="font-medium">OOP</span>
                            </div>
                        </td>
                        <td class="py-3 px-6 text-center">
                            <div class="flex items-center">
